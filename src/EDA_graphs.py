...
col_names = ["Protocol", "Packet Type", "Malware Indicators", "Alerts/Warnings", "Attack Signature", "Action Taken",
             "Severity Level", "Browser family", "OS family", "Device Type", "Network Segment", "Proxy usage",
...
fig = subp(
    ...
    subplot_titles=[
        ...
        f"Geographical distribution of {col_names[0]} for {attypes[0]} attack types",
        f"Geographical distribution of {col_names[1]} for {attypes[0]} attack types",
        f"Geographical distribution of {col_names[0]} for {attypes[1]} attack types",
        f"Geographical distribution of {col_names[1]} for {attypes[1]} attack types",
        f"Geographical distribution of {col_names[0]} for {attypes[2]} attack types",
        f"Geographical distribution of {col_names[1]} for {attypes[2]} attack types"
    ],
