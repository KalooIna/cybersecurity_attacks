"""
Quick Analysis Script - Run the complete ML pipeline and generate results.
This script performs EDA, preprocessing, model training, and evaluation.
"""
...
print("="*80)
print("CYBERSECURITY ATTACK TYPE DETECTION - QUICK ANALYSIS")
print("="*80)
